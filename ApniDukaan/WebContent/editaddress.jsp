...
<%
	...
	AddressBean ab = AddressDao.getSingleRecords(userid);	
%> 
    <header> 
        <div class="header">
    ...
    <div class="container form-container">
        ...
        <form class = "form-body" action = "./EditAddress" method = "POST">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" maxlength="10" value = "<%= ab.getMobilenumber() %>" placeholder="Mobile Number">
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id = "housenobuildingname" name="housenobuildingname" value = "<%= ab.getHousenobuildingname() %>" placeholder="House No. / Building Name">
                </div>
                <div class="form-group col-md-6">
                    <label for="roadnameareacolony">Road Name, Area, Colony<span style = "color:red;font-size:14px;font-weight:bolder;">*</span></label>
                    <input type="text" class="form-control" id = "roadnameareacolony" name="roadnameareacolony" value = "<%= ab.getRoadnameareacolony() %>" placeholder="Road Name, Area, Colony">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id = "landmark" name="landmark" value = "<%= ab.getLandmark() %>" placeholder="Lankmark">
                </div>
                <div class="form-group col-md-6">
                    <label for="pincode">Pincode<span style = "color:red;font-size:14px;font-weight:bolder;">*</span></label> 
                    <input type="text" class="form-control" id = "pincode" name="pincode" maxlength="6" value = "<%= ab.getPincode() %>" placeholder="Pincode">
                </div>
            </div>          
