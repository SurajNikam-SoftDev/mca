...
<%
	...
	String refno = request.getParameter("refno") != null || request.getParameter("refno") != ""
			...
			: "undefined";
			refno = refno.isEmpty() ? "undefined" : refno; 
...
%> 
	...
	<div class = "container-fluid trackorder-container  mt-2">
		<b style = "padding:10px;font-size:14px;font-weight:bolder">Track Order</b>
<%
List<TrackOrderBean> list = TrackOrderDao.getTrackOrderByReferenceNo(refno);
