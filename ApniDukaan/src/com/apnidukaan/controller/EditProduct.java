...
public class EditProduct extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(key + " :: " + productname + " :: " +productsubtitle+ " :: " +productprice+ " :: " +category+ " :: " +cashondelivery+ " :: " +allowreturn+ " :: " +height+ " :: " +weight+ " :: " +width+ " :: " +length+ " :: " +stock+ " :: " +returnperiod+ " :: " +description);
			
		ProductBean pb = new ProductBean();
 		pb.setPid(Integer.parseInt(key));
		...
		pb.setUserid(userid);
		session.setAttribute("EditProductKey", key);
		session.setAttribute("EditProductData", pb); 
		//System.out.println("session set succesfully");
		response.sendRedirect("./EditProductImageUpload");
	}
