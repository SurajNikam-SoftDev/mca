...
/**
 * Servlet implementation class ProductImageUpload
 */
...
public class ProductImageUpload extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("productimageupload.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            ProductBean pb = (ProductBean) session.getAttribute("ProductBeanDetails");
            
            int status = ProductDao.save(pb, imgfilename);
